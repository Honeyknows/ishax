                  ...
                  <>
                    <button
                      ...
                      style={{
                        ...
                        color: 'var(--accent)', background: 'var(--bg-3)', border: '1px solid var(--border)',
                        borderRadius: 6, cursor: 'pointer'
                      }}
                    >
                      View {(alerts || []).length} investigated alert(s) →
                    </button>
                    <button
                      onClick={() => {
                        setInvestigatedIds(new Set())
                        localStorage.removeItem('ishax_investigated_alerts')
                      }}
                      style={{
                        padding: '3px 8px', fontSize: 10, fontWeight: 500,
                        color: 'var(--text-3)', background: 'transparent', border: '1px borderless var(--border)',
                        cursor: 'pointer', textDecoration: 'underline'
                      }}
                    >
                      Reset Investigated Filter
                    </button>
                  </>
                )}
                <button
