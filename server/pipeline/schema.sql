...
CREATE INDEX IF NOT EXISTS idx_events_agent_ts    ON events(agent_name, wazuh_ts_epoch DESC);
...
CREATE TABLE IF NOT EXISTS unknown_agents (
...
CREATE INDEX IF NOT EXISTS idx_unknown_agents_last_seen ON unknown_agents(last_seen_epoch);
